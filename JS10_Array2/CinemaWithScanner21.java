                    ...
                    while (true) {
                        ...
                        for (int ticket = 1; ticket <= 2; ticket++) {
                            do {
                                ...
                                if (row >= 1 && row <= audience.length && column >= 1
                                        && column <= audience[row - 1].length) {
                                    if (audience[row - 1][column - 1] == null) {
                                        audience[row - 1][column - 1] = name;
                                        System.out.println("Booking on behalf of " + name + " for "
                                                + movieTitles[movieSelection - 1] +
                                                " at " + movieSchedules[movieSelection - 1] + " in row " + row
                                                + ", column " + column);
                                    } else {
